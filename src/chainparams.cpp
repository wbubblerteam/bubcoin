...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.bubcoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.bubcoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.bubcoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.bubcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.bub.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.bubcoin.sprovoost.nl"); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        vSeeds.emplace_back("seed.bubcoin.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bubcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbub.petertodd.org");
        vSeeds.emplace_back("seed.testnet.bubcoin.sprovoost.nl");
