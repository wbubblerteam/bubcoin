...
#ifndef BUBCOIN_NET_H
#define BUBCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/bubcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bubcoin’s Peer-to-Peer Network")
