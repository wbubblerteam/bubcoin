...
#ifndef BUBCOIN_TEST_SCRIPTNUM10_H
#define BUBCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bubcoin Core 0.10.0, for cross-comparison.
 */
public:
