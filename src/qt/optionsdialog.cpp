    ...
    mapper(nullptr)
{
    ...
    ui->bubcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bubcoinAtStartup);
    ...
    ui->bubcoinAtStartup->setToolTip(ui->bubcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bubcoinAtStartup->setText(ui->bubcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBubcoinConfButton->setToolTip(ui->openBubcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BubcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bubcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBubcoinConfButton_clicked()
{
