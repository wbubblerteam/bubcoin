...
//! Entry point for BubcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BubcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BubcoinGUI tests.
void AppTests::guiTests(BubcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BubcoinGUI::consoleShown, this, &AppTests::consoleTests);
