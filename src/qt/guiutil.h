...
#ifndef BUBCOIN_QT_GUIUTIL_H
#define BUBCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Bubcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bubcoin:" URI into recipient object, return true on successful parsing
