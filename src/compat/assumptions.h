...
#ifndef BUBCOIN_COMPAT_ASSUMPTIONS_H
#define BUBCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Bubcoin cannot be compiled without assertions."
#endif
...
#endif // BUBCOIN_COMPAT_ASSUMPTIONS_H
