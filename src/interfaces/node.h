...
#ifndef BUBCOIN_INTERFACES_NODE_H
#define BUBCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a bubcoin node (bubcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BUBCOIN_INTERFACES_NODE_H
