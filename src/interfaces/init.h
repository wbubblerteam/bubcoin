...
#ifndef BUBCOIN_INTERFACES_INIT_H
#define BUBCOIN_INTERFACES_INIT_H
...
//! (bubcoin-gui, bubcoin-node, bubcoin-wallet, bubcoind, bubcoin-qt) and each
...
#endif // BUBCOIN_INTERFACES_INIT_H
