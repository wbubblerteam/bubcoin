// Copyright (c) 2020-2021 The Bubcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BUBCOIN_INDEX_COINSTATSINDEX_H
#define BUBCOIN_INDEX_COINSTATSINDEX_H
...
#endif // BUBCOIN_INDEX_COINSTATSINDEX_H
