...
#ifndef BUBCOIN_SCRIPT_STANDARD_H
#define BUBCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bubcoin address
 */
...
/**
 * Generate a Bubcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BUBCOIN_SCRIPT_STANDARD_H
