...
#ifndef BUBCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BUBCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Bubcoin Core wallet was originally a collection of unrelated private
...
#endif // BUBCOIN_WALLET_SCRIPTPUBKEYMAN_H
