...
#ifndef BUBCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BUBCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BUBCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
