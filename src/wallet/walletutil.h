...
#ifndef BUBCOIN_WALLET_WALLETUTIL_H
#define BUBCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bubcoin from opening the wallet, thinking it was newly created, and
...
#endif // BUBCOIN_WALLET_WALLETUTIL_H
