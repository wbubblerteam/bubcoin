 ...
 */
#ifndef BUBCOIN_UTIL_SYSTEM_H
#define BUBCOIN_UTIL_SYSTEM_H
...
extern const char * const BUBCOIN_CONF_FILENAME;
extern const char * const BUBCOIN_SETTINGS_FILENAME;
