...
#ifndef BUBCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BUBCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bubcoin.
 *
 ...
 *
 * The chacha20-poly1305@bubcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bubcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bubcoin are relatively fast in
...
#endif // BUBCOIN_CRYPTO_CHACHA_POLY_AEAD_H
