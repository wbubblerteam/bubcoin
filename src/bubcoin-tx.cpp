...
static void SetupBubcoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bubcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bubcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bubcoin transaction\n" +
            "or:     bubcoin-tx [options] -create [commands]   Create hex-encoded bubcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bubcoin transaction
