...
class P2PPermissionsTests(BubcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bubcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bubcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
