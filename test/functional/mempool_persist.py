...
By default, bubcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BubcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bubcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
