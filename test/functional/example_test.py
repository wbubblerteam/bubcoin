...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BubcoinTestFramework
    pass


class ExampleTest(BubcoinTestFramework):
    # Each functional test is a subclass of the BubcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BubcoinTestFramework class so other tests can use it."""
