...
"""Verify that starting bubcoin with -h works as expected."""

from test_framework.test_framework import BubcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BubcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bubcoin with -h for help text")
        ...
        self.log.info("Start bubcoin with -version for version information")
        ...
        self.log.info("Start bubcoind with -fakearg to make sure it does not start")
