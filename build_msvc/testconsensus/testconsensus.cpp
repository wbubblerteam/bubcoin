...
// bubcoin includes.
#include <..\src\script\bubcoinconsensus.h>
...
int main()
{
    std::cout << "bubcoinconsensus version: " << bubcoinconsensus_version() << std::endl;
    ...
    auto op0Result = bubcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bubcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
