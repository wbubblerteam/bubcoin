...
This document provides guidelines for internationalization of the Bubcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bubcoin_en.ts` remains unchanged.
