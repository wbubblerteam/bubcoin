Bubcoin Core version 0.9.2.1 is now available from:

  https://bubcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BUB to 0.01 BUB
...
- Fix "Start bubcoin on system login"
