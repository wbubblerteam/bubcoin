Bubcoin Core version 0.10.4 is now available from:

  <https://bubcoin.org/bin/bubcoin-core-0.10.4/>
...
- #6953 `43c2789` Split bubcoin-tx into its own package
- #6953 `dfe0d4d` Include bubcoin-tx binary on Debian/Ubuntu
