Bubcoin Core version 0.16.1 is now available from:

  <https://bubcoincore.org/bin/bubcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting bubcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bubcoind processes are cleaned up when tests end (sdaftuar)
