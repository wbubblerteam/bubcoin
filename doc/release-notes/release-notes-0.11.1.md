Bubcoin Core version 0.11.1 is now available from:

  <https://bubcoin.org/bin/bubcoin-core-0.11.1/>
...
(see https://github.com/bubcoin/bubcoin/pull/6795).
...
one was randomly violated by all deployed bubcoin software prior to
...
Bubcoin Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Bubcoinj has done so for a similar span of time.
Bubcoinjs and electrum have been more recently updated.
...
[1] On the Malleability of Bubcoin Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/bubcoin/paper_9.pdf
...
(see https://github.com/bubcoin/bubcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libbubcoinconsensus: avoid a crash in multi-threaded environments
