Bubcoin Core version 0.9.4 is now available from:

  https://bubcoin.org/bin/0.9.4/
...
this update is incompatible with the Bubcoin system and could lead to consensus
forks.

Bubcoin Core released binaries from https://bubcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bubcoin/+archive/ubuntu/bubcoin
- A third-party or self-compiled Bubcoin Core

upgrade to Bubcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
