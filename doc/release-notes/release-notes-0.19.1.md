...
Bubcoin Core version 0.19.1 is now available from:

  <https://bubcoincore.org/bin/bubcoin-core-0.19.1/>
...
From Bubcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bubcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bubcoin Core does not yet change appearance when
...
- #17488 fix "bubcoind already running" warnings on macOS (fanquake)
