Bubcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bubcoin/files/Bubcoin/bubcoin-0.5.4/
...
http://gitorious.org/bubcoin/bubcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bubcoin-Qt notifications under Growl 1.3.
Increase required age of Bubcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBubcoin properly when installing Bubcoin-Qt over it. (Windows)
