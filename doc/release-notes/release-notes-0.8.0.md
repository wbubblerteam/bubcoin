Bubcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bubcoin/files/Bubcoin/bubcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bubcoin
...
New/changed settings (command-line or bubcoin.conf file)
--------------------------------------------------------
