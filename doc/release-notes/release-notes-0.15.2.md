Bubcoin Core version *0.15.2* is now available from:

  <https://bubcoincore.org/bin/bubcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bubcoin-tx (TheBlueMatt)
