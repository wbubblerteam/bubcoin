Bubcoin Core version 0.13.2 is now available from:

  <https://bubcoin.org/bin/bubcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bubcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bubcoin-tx to create v2 transactions (bubdrak)
