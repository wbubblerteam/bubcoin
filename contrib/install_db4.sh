#!/bin/sh
# Copyright (c) 2017-2019 The Bubcoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bubcoin repository."
  exit 1
fi
...
# See https://github.com/bubcoin/bubcoin/issues/16064
...
echo 'When compiling bubcoind, run `./configure` in the following way:'
echo
