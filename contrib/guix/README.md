# Bootstrappable Bubcoin Core Builds

This directory contains the files necessary to perform bootstrappable Bubcoin
Core builds.
...
- 24GB of free disk space on the partition that the Bubcoin Core git repository
  resides in
...
For a Bubcoin Core depends development environment, simply invoke
...
From the top of a clean Bubcoin Core repository:
...
To use dongcarl's substitute server for Bubcoin Core builds after having
