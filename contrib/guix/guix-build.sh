...
# Deterministically build Bubcoin Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/bubcoin/' to
        #     '/home/satoshi/bubcoin/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/bubcoin
        #
        #                     maps our current working directory to /bubcoin
        ...
        #     container so that we have something to build. '/bubcoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /bubcoin && bash contrib/guix/libexec/build.sh"
    )
