...
(define* (make-bubcoin-cross-toolchain target
                                       #:key
...
desirable for building Bubcoin Core release binaries."
...
(define glibc-2.27/bubcoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-bubcoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/bubcoin-patched
