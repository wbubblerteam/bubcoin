...
def main():
    ...
    # Filter out hosts with multiple bubcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple bubcoin ports' % (ip_stats(ips)), file=sys.stderr)
