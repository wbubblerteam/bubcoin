...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BUBCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define BUBCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bubcoin network\n')
    ...
    g.write('#endif // BUBCOIN_CHAINPARAMSSEEDS_H\n')
