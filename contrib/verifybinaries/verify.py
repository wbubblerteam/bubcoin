...
"""Script for verifying Bubcoin Core release binaries
...
def main(args):
    ...
    if not success:
        print("bubcoin.org failed to provide signature file, "
              "but bubcoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("bubcoin.org and bubcoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Bubcoin Core binary release "
