...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Bubcoin
else
  DOCKER_EXEC echo \> \$HOME/.bubcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/bubcoin/bubcoin/pull/18288#discussion_r433189350 for
  # details.
